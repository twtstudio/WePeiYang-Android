...
/**
 * Created by rickygao on 2018/2/7.
 */
...
fun Path.cubicThrough(points: List<PointF>, cpHRatio: Float = 0.618F, cpVRatio: Float = 0F) =
        cubicThrough(points.asSequence(), cpHRatio, cpVRatio)

fun Path.cubicThrough(points: Sequence<PointF>, cpHRatio: Float = 0.618F, cpVRatio: Float = 0F) =
