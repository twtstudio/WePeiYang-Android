...
public interface Api {
    ...
    @FormUrlEncoded
    @POST("party/")
    Call<Status> submitAnswer(@Query("page") String page, @Query("do") String doWhat, @Query("sno") String sno, @Field("course_id") int courseId, @Field("answer") String rightAnswer, @Field("exercise_answer") String exercise_answer, @Field("submit") String submit);
